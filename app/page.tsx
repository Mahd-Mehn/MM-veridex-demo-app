    ...
    return (
      <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-900 via-purple-900/50 to-slate-900">
        ...
        <footer className="p-4 text-center">
          ...
          {/* Help link */}
          <a
            href="https://t.me/+esxlkvlnsAJlMTdk"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 rounded-full text-blue-300 hover:text-white hover:border-blue-400/50 transition-all text-sm"
          >
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      >
        <div className="relative">
          ...
          {/* Main button */}
          <div className="relative flex items-center gap-2 px-4 py-3 bg-gradient-to-r from-blue-500 to-cyan-400 text-white font-medium rounded-full shadow-lg hover:shadow-cyan-500/25 hover:scale-105 transition-all duration-300">
            {/* Telegram icon */}
          ...
          {/* Tooltip on hover */}
          <div className="absolute bottom-full right-0 mb-2 px-3 py-2 bg-slate-800 text-white text-sm rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all whitespace-nowrap border border-white/10 shadow-xl">
            Chat with us on Telegram
            <div className="absolute top-full right-4 w-0 h-0 border-l-8 border-r-8 border-t-8 border-transparent border-t-slate-800" />
          </div>
        </div>
      </a>
    </div>
